...
--
-- Host: localhost    Database: sqlix2
-- ------------------------------------------------------
...
--
-- Current Database: `sqlix2`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `sqlix2` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `fabriquer` (
  ...
  CONSTRAINT `fabriquer_ibfk_2` FOREIGN KEY (`num_potion`) REFERENCES `habitant` (`num_hab`)
...
INSERT INTO `village` VALUES (1,'Aquilona',52,1),(3,'Aginum',33,3),(4,'Calendes Aquae',42,2),(5,'Condate',38,1),(6,'Gergovie',55,3),(7,'Aquae Calidae',35,2);
...
-- Dump completed on 2021-02-23 12:55:19
